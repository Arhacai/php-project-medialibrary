...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($name == "" || $email == "" || $category == "" || $title == "") {
        $error_message = "Please fill in the required fields: Name, Email, Cateogory and Title";
    }
    ...
    if (!isset($error_message)) {
        ...
        $mail->Username = "arhacai@gmail.com";
        //Password to use for SMTP authentication
        $mail->Password = "nvxbtalumzzfeyhf";
        //It's important not to use the submitter's address as the from address as it's forgery,
        //which will cause your messages to fail SPF checks.
        //Use an address in your own domain as the from address, put the submitter's address in a reply-to
        $mail->setFrom('arhacai@gmail.com', $name);
        $mail->addReplyTo($email, $name);
        $mail->addAddress('arhacai@gmail.com', 'Adrian');
    ...
    <div class="wrapper">
        ...
        <form method="post" action="suggest.php">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <select id="category" name="category">
                            ...
                            if (isset($category) && $category=="Audio") {
                                echo " selected";
                            } ?>>Movies</option>
                ...
                <tr>
                    <th><label for="title">Title<sup>*</sup></label></th>
